...
| V3 | 0.493 | 0.211 | 0.507 | 0.567 | 0.535 | <br>
...
| Mild Augmentation | YOLO11n | 0.446 | 0.165 | 0.501 | 0.570 | 0.533 | <br>
...
| Model | mAP@0.5 | mAP@0.5:0.95 | Precision | Recall |
|--------|----------|--------------|-----------|--------|
| YOLO11s | 0.580 | 0.248 | 0.587 | 0.681 | <br>
...
|--------------|----------|--------------|-----------|--------|
| YOLO11s + TTA | 0.597 | 0.275 | 0.585 | 0.726 | <br>
...
| After Post-Processing | 12.43 | 17.76 | 64.12 | <br>
